      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
	        <form id="from" action="/lykj/admin/teacherSalary?tid=${tid}" method="post">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>教师工资<small></small></h2>
                     <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable-checkbox" class="table table-striped jambo_table bulk_action">
                      <thead>
                        <tr class="headings">
                          ...
                          <th class="column-title">基础工资</th>
                          <th class="column-title">基础奖金</th>
                          <th class="column-title">实际工资</th>
                      ...
                      <c:forEach var="course" items="${list}">
                        <tr>
                          ...
                          <td>${course.basesalary}</td>
                          <td>${course.reward}</td>
                          <td>${course.salary}</td>
                          <td><a href="/lykj/admin/goSalaryUpdate?id=${course.id}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 修改 </a></td>
                        </tr> 
                        </c:forEach>
                        <tr>
                          <td>总和</td>
                          ...
                          <td>${two}</td>
                          <td>${total}</td>
                          <td><a href="/lykj/admin/salaryEnd?tid=${tid}" class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> 完结 </a></td>
                        </tr>
                      </tbody>
                    </table>
                    </div>
