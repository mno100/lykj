          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>课程信息添加<small></small></h2>

                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="form" action="/lykj/admin/courseAdd" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">教师ID<span class="required">：</span>
                        </label>
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="text" id="tid" name="tid" required="required"class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">学生ID<span class="required">：</span>
                        </label>
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="text" id="sid" name="sid" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                    ...
                    <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker1" name="endtime"/>
                    <div class="input-group-append" data-target="#datetimepicker1" data-toggle="datetimepicker">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">基础工资<span class="required">：</span>
                        </label>
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="text" id="basesalary" name="basesalary" required="required"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group" >
                        <div class="col-md-2 col-sm-10 col-xs-12 col-md-offset-3">
                          <button class="btn btn-primary" type="button" onclick="javascript:location.href='/lykj/admin/teacherCourse'">返回</button>
						  <button class="btn btn-primary" type="reset" onclick="javascript:location.href='/lykj/admin/goCourseAdd'">重置</button>
