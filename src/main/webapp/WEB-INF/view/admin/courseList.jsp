          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>课程列表<small></small></h2>
                  
                       
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                   <form id="from" action="/lykj/admin/courseList" method="post">
                    <!-- 选择条件 -->
                    <div class="row">
                  	<div style="padding: 2px 0px 10px 2px;margin-bottom: 30px;">                  
                  	<div style="float: left;margin-left: 20px;"><span>课程名:</span>
                    ...
                    <table id="datatable-checkbox" class="table table-striped jambo_table bulk_action">
                      ...
                      <c:forEach var="course" items="${list}">
                        <tr>
                          ...
                          <td>
                          <a href="/lykj/admin/goCourseUpdate?id=${course.id}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 修改 </a>
                          	|
                           <a href="/lykj/admin/courseDel?id=${course.id}" onclick="javascript:return delIsnot();"  class="btn btn-danger btn-xs">
