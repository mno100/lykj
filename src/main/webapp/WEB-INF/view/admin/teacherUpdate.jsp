            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                   <form id="form" action="/lykj/admin/teacherUpdate" method="post" data-parsley-validate class="form-horizontal form-label-left">
                   <input type="hidden" name="id" value="${teacher.id}">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="text" id="age" name="age" required="required" class="form-control col-md-7 col-xs-12"value="${teacher.age}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="text" id="mobile" name="mobile" required="required"  class="form-control col-md-7 col-xs-12" value="${teacher.mobile}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="text" id="wechat" name="wechat" required="required"  class="form-control col-md-7 col-xs-12" value="${teacher.wechat}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="text" id="address" name="address" required="required" class="form-control col-md-7 col-xs-12" value="${teacher.address}">
                        </div>
                      </div> 
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="text" id="language" name="language" required="required" class="form-control col-md-7 col-xs-12" value="${teacher.language}">
                        </div>
                      </div> 
