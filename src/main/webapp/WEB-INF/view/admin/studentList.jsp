          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>学生列表<small></small></h2>
                  
                       
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                   <form id="from" action="/lykj/admin/studentList" method="post">
                    <!-- 选择条件 -->
                    <div class="row">
                  	<div style="padding: 2px 0px 10px 2px;margin-bottom: 30px;">                  
                  	<div style="float: left;margin-left: 20px;"><span>学生名:</span>
                    ...
                    <table id="datatable-checkbox" class="table table-striped jambo_table bulk_action">
                      <thead>
                        <tr class="headings">
                          ...
                          <th class="column-title">学生ID</th>
                          <th class="column-title">学生姓名</th>
                          <th class="column-title">出生年月</th>
                          <th class="column-title">联系方式</th>
                          <th class="column-title">微信号</th>
                          <th class="column-title">有无基础</th>
                          <th class="column-title">基础测试成绩</th>
                          <th class="column-title">学生课程</th>
                      ...
                      <c:forEach var="student" items="${list}">
                        <tr>
                          ...
                          <td>${student.base}</td>
                          <td>${student.basetest}</td>
                          <td><a href="/lykj/admin/studentCourse?sid=${student.id}">课程表</a></td>
                          <td>
                          <a href="/lykj/admin/studentInfo?id=${student.id}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> 查看 </a>
                          	|
                          <a href="/lykj/admin/goStudentUpdate?id=${student.id}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 修改 </a>
                          	|
                          <c:choose>
                           <c:when test="${student.decide == 0}">
                           <a href="/lykj/admin/studentGo?id=${student.id}" onclick="javascript:return backIsnot();" class="btn btn-warning btn-xs">
                           <i class="fa fa-pencil"></i>退学</a>	
                           </c:when>
                           <c:otherwise>
					   	   <a href="/lykj/admin/studentBack?id=${student.id}" class="btn btn-success btn-xs">
                           <i class="fa fa-pencil"></i>返学</a>	
                           </c:otherwise>
                          </c:choose>
                           <a href="/lykj/admin/studentDel?id=${student.id}" onclick="javascript:return delIsnot();"  class="btn btn-danger btn-xs">
