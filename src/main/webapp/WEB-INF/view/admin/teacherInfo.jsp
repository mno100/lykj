                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name">教师ID<span class="required">:</span>
                        </label>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="last-name">教师名称<span class="required">:</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top: 7px;">
                        ${teacher.name}
                        </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="last-name">教师年龄<span class="required">:</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top: 7px;">
                        ${teacher.age}
                        </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="last-name">教学语言<span class="required">:</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top: 7px;">
                        ${teacher.language}
                        </div>
