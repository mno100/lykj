          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>学生信息添加<small></small></h2>

                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="form" action="/lykj/admin/studentAdd" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">出生日期<span class="required">：</span>
                        </label>
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="date" id="age" name="age" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-10 col-xs-12">
                           ...
                           <label class="radio-inline"><input type="radio" name="base" value="无基础">无基础</label>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-10 col-xs-12">
                          <input type="text" id="basetest" name="basetest" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>   
                      ...
                      <div class="form-group" >
                        <div class="col-md-2 col-sm-10 col-xs-12 col-md-offset-3">
						  ...
						  <button class="btn btn-primary" type="reset" onclick="javascript:location.href='/lykj/admin/goStudentAdd'">重置</button>
